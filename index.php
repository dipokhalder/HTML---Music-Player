...
<div class="item__play__box" id="plybox1">
    <div class="item__header">
		...
		<audio preload id="audio1" controls="controls" src="ro_ne_do.amr" type="audio/amr">Your browser does not support HTML5 Audio!</audio>
    </div>

    <ul class="item__playlist" id="playlist1">
    	<li class="active">
    		<div class="playlist__item" onclick="audioPlaylist(this, 'plybox1', 'tere_bin.mp3', 'audio1', 'playlist1');">
    			<div class="item__sl">1.</div>
    			<div class="item__title">Tere Bin</div>
    			<div class="item__length">2:46</div>
    		</div>
    	</li>
    	<li>
    		<div class="playlist__item" onclick="audioPlaylist(this, 'plybox1', 'ro_ne_do.amr', 'audio1', 'playlist1');">
    			<div class="item__sl">1.</div>
    			<div class="item__title">Ro Ne Do</div>
    			<div class="item__length">2:46</div>
    		</div>
    	</li>
    </ul>
    ...
    <ul class="item__playlist" id="playlist2">
    	<li class="active">
    		<div class="playlist__item" onclick="videoPlaylist(this, 'plybox2', 'a.mp4', 'video1', 'playlist2');">
    			<div class="item__sl">1.</div>
    			<div class="item__title">Mitti Da Kushbu</div>
    			<div class="item__length">2:46</div>
    		</div>
    	</li>
    	<li class="">
    		<div class="playlist__item" onclick="videoPlaylist(this, 'plybox2', 'b.mp4', 'video1', 'playlist2');">
    			...
    			<div class="item__title">Daiya Daiya Daiya Re</div>
    			<div class="item__length">2:46</div>
    		</div>
    	</li>
    </ul>
